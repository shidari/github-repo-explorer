...
const OWNERS = [
  "facebook", "vercel", "microsoft", "honojs", "Effect-TS",
  "google", "apple", "denoland", "vuejs", "sveltejs",
  "rust-lang", "golang", "nodejs", "python", "ruby",
  "docker", "kubernetes", "hashicorp", "mozilla", "apache",
  "jetbrains", "redhat", "elastic", "grafana", "prisma",
  "supabase", "cloudflare", "stripe", "shopify", "github",
  "gitlab", "atlassian", "slack", "discord", "spotify",
  "netflix", "airbnb", "uber", "twitter", "linear",
  "tailwindlabs", "shadcn", "biomejs", "drizzle-team", "trpc",
  "tanstack", "pmndrs", "remix-run", "solidjs", "astro-community",
] as const;
const REPOS = [
  "react", "next.js", "typescript", "hono", "effect",
  "vue", "svelte", "vite", "node", "deno",
  "remix", "angular", "bun", "astro", "nuxt",
  "solid", "preact", "qwik", "fresh", "htmx",
  "rust", "go", "python", "ruby", "swift",
  "kotlin", "elixir", "zig", "gleam", "roc",
  "docker", "terraform", "ansible", "grafana", "prometheus",
  "redis", "postgres", "sqlite", "drizzle", "prisma",
  "tailwindcss", "shadcn-ui", "radix", "ark-ui", "mantine",
  "trpc", "zod", "valibot", "arktype", "effect-schema",
] as const;
const DESCRIPTIONS = [
  ...
  "A fast and modern build tool for the web.",
  ...
  "A blazingly fast bundler.",
  "Build websites with content, any framework.",
  "The intuitive web framework.",
  undefined,
] as const;
const LANGUAGES = [
  "JavaScript", "TypeScript", "Rust", "Go", "Python",
  "Ruby", "Swift", "Kotlin", "Elixir", "Zig",
  null,
] as const;
const LICENSES = [
  ...
  { key: "isc", name: "ISC License" },
  { key: "mpl-2.0", name: "Mozilla Public License 2.0" },
  { key: "unlicense", name: "The Unlicense" },
  undefined,
] as const;
const TOPICS = [
  "typescript", "javascript", "react", "nodejs", "web",
  "api", "framework", "functional-programming", "effect", "open-source",
  "frontend", "backend", "fullstack", "devtools", "cli",
  "database", "orm", "testing", "css", "ui",
] as const;
